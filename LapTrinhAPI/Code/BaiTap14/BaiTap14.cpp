// BaiTap14.cpp : Defines the entry point for the application.
//
...
INT_PTR CALLBACK    RegisterSV(HWND, UINT, WPARAM, LPARAM);
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_BAITAP14, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_BAITAP14));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_BAITAP14));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_BAITAP14);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
	{
		...
		{
		case ID_REGISTER_SV:
			DialogBox(hInst, MAKEINTRESOURCE(IDD_DIALOG_REGISTER), hWnd, About);
			//MessageBox(NULL, TEXT("TS"), TEXT("SFS"), NULL);
			break;
		case IDM_ABOUT:
...
INT_PTR CALLBACK RegisterSV(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
	//HWND cboKhoa, cboKhoaHoc;
	int count;
	UNREFERENCED_PARAMETER(lParam);
	switch (message)
	{
